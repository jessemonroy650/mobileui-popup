...
1. .hidden - set the block to initial be hidden
...
2. .popUp - set the block to be seen & set the initial state for animation
...
3. .fadeOut - set the block to fadeOut (via CSS animation)
